...
export const ANIMALS = {
  ...
  hamster: {
    ...
    name: "햄스터 가족",
    icon: "🐹",
    ability: "아몬드와 조합 (볼빵빵 보너스)",
    description: "단독 능력은 없어요. 아몬드 바구니와 함께 대소동 없이 진료를 마치면, 이번에 확보한 카드 수만큼 귀가 더미에서 카드를 무작위로 더 가져와요.",
  },
  almond: {
    id: "almond",
    name: "아몬드 바구니",
    icon: "🥜",
    ability: "햄스터와 조합 (볼빵빵 보너스)",
    description: "단독 능력은 없어요. 햄스터 가족과 함께 대소동 없이 진료를 마치면, 이번에 확보한 카드 수만큼 귀가 더미에서 카드를 무작위로 더 가져와요.",
  },
  mole: {
    id: "mole",
    name: "두더지 가족",
